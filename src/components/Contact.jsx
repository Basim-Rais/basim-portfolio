        ...
        <div name='Contact' className='w-full h-full bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
            ...
            <div className='max-w-screen-lg flex flex-col p-4 justify-center mx-auto h-full'>
                ...
                <div className='flex justify-center items-center'>
                    <form action="https://getform.io/f/bolgdvda" method='POST' className='flex flex-col w-full md:w-1/2'>
                        <input 
                        type="text" 
                        name='name' 
                        placeholder='Enter your name' className='my-4 p-2 bg-transparent border-2 rounded-md text-white focus:outline-none' />
